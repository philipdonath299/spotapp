        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-black text-white p-4">
            <div className="text-center max-w-md">
                ...
                <div className="mt-8 p-4 bg-neutral-900/50 rounded-lg border border-neutral-800">
                    <p className="text-xs text-neutral-500 mb-2 uppercase tracking-widest font-bold">Whitelisted URI (Add to Spotify Dashboard)</p>
                    <code className="text-green-400 text-xs block break-all font-mono select-all">
                        {REDIRECT_URI}
                    </code>
                </div>
            </div>
